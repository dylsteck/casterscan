          ...
          <ul className="list-none">
            <li className="flex justify-between items-center mb-1">
              ...
              <span className="flex items-center text-right">
                {eventData.id ?? 'N/A'}
                <CopyClipboardIcon value={String(eventData.id ?? 'N/A')} className="ml-1 flex-shrink-0" />
              </span>
            </li>
            <li className="flex justify-between items-center mb-1">
              ...
              <span className="flex items-center text-right">
                ...
                <CopyClipboardIcon value={eventData.type || 'UNKNOWN'} className="ml-1 flex-shrink-0" />
              </span>
            </li>
            <li className="flex justify-between items-center mb-1">
              <span className="font-semibold mr-1">block number</span>
              <span className="flex items-center text-right">
                {eventData.blockNumber ?? 'N/A'}
                <CopyClipboardIcon value={String(eventData.blockNumber ?? 'N/A')} className="ml-1 flex-shrink-0" />
              </span>
            </li>
            <li className="flex justify-between items-center mb-1">
              <span className="font-semibold mr-1">shard index</span>
              <span className="flex items-center text-right">
                {eventData.shardIndex ?? 'N/A'}
                <CopyClipboardIcon value={String(eventData.shardIndex ?? 'N/A')} className="ml-1 flex-shrink-0" />
              </span>
            </li>
            ...
            {eventData.fid && (
              <li className="flex justify-between items-center mb-1">
                ...
                <span className="flex items-center text-right">
                  <Link to={`/fids/${eventData.fid}`} className="text-black underline">
                    {eventData.fid}
                  </Link>
