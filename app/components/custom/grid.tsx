...
import type { type PruneEvent, type SnapchainEvent, type User } from '../../lib/types';
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end">
        <a href={event.link} target={event.link.startsWith('/') ? undefined : '_blank'} rel="noreferrer">
